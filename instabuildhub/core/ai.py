...
from langchain.chat_models import AzureChatOpenAI, ChatOpenAI, ChatGooglePalm
...
# from palm.palm_openai_api import PalmOpenAiApi
...
class AI:
    ...
    def __init__(self, model_name="google_palm", temperature=0.1, azure_endpoint=""):
        """
    ...
    def _check_model_access_and_fallback(self, model_name) -> str:
        ...
        """
        try:
            palm.Model.retrieve(model_name)
            # needed to handle the correct way
        except:
            print(
